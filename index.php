...
<html lang="en">
  <head>
    <title>Yonzikon 11/DW Menzikon</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">YONZIKON 11/DW</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#about-section" class="nav-link"><span>Profil Satuan</span></a></li>
	          <li class="nav-item"><a href="#practice-section" class="nav-link"><span>Publikasi</span></a></li>
	          <li class="nav-item"><a href="#attorneys-section" class="nav-link"><span>Pejabat Satuan</span></a></li>
	          <li class="nav-item"><a href="#blog-section" class="nav-link"><span>kegiatan Persit</span></a></li>
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contact</span></a></li>
	          <!-- <li class="nav-item cta"><a href="#" class="nav-link" data-toggle="modal" data-target="#modalAppointment">Request a quote</a></li> -->
	        </ul>
	      </div>
	    </div>
	  </nav>

	   <section class="hero-wrap js-fullheight" style="background-image: url('images/TNI.jpg');" data-section="home">
      ...
      <div class="container">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-6" data-scrollax="properties: { translateY: '40%', opacity: 1.6 }">DURDHAGA WIGHRA</h1>
            <p class="mb-6" data-scrollax="properties: { translateY: '40%', opacity: 1.6 }">"Bekerja dengan penuh rasa tanggung jawab dengan semangat gotong royong "</p>
    ...
    <section class="ftco-about ftco-no-pt ftco-no-pb img ftco-section bg-light" id="about-section">
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-5 col-lg-6 d-flex order-md-last">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(images/mako.jpg);">
    			...
    			<div class="col-md-6 col-lg-6 pr-lg-5 py-3 py-lg-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		          	<span class="subheading">SEJARAH SATUAN</span>
		            <h2 class="mb-5" style="font-size: 20px; text-transform: capitalize;">BATALYON ZENI KONSTRUKSI 11/DW MENZIKON</h2>
		            <p>Sejarah singkat ini diangkat dari kegiatan Batalyon Zeni Konstruksi 11/DW sejak berdirinya tanggal 24 Agustus 1965 sampai dengan sekarang dan belum dapat disebutkan sebagai suatu sejarah dalam arti lengkap dan terinci serta mencerminkan adanya pendekatan yang obyektif menurut kriteria ilmu sejarah.</p>
		            <p><!-- Berdasarkan surat keputusan Direktorat Zeni Angkatan Darat Nomor : Skep-199/VIII/1965 tanggal 24 Agustus 1965, tentang Keputusan Peresmian berdirinya Kesatuan Yonzikon 14/SWS dengan pejabat Komandan Batalyon Mayor Corps Zeni Kacung Dharmadi NBI 13931. Sesuai dengan kebutuhan organisasi dan guna mempermudah pencapaian tugas pokok, maka Yonzikon 14/SWS sejak berdirinya tahun 1965 hingga tahun 1986 mengalami pengembangan dan penyempurnaan organisasi dengan Surat Perintah Direktur Zeni TNI Angkatan Darat Nomor : Sprin/529/V/1986 tanggal 16 Mei 1986, Yonzikon 14/SWS kembali kejajaran Resimen Zeni Konstruksi hingga saat ini --></p>
		          </div>
		        </div>
	        </div>
        </div>
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(images/zikon.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate pb-5">
		          	<span class="subheading">YONZIKON 11/DW</span>
		            <h2 class="mb-4" style="font-size: 44px; text-transform: capitalize;">DURDHAGA WIGHRA</h2>
		          </div>
		          <div class="col-md-12 testimony-section">
								<div class="owl-carousel carousel-testimony">
				          		...
				          		<div class="text mb-5">
				          			...
				          			<p>Bekerja dengan penuh rasa tanggung jawab dengan semangat gotong royong</p>
				          		</div>
				          		<!-- <div class="d-flex">
              ...
              <div class="tab-pane fade show active py-0 py-lg-5" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
              	<div class="d-lg-flex">
	              	<div class="icon-law mr-md-4 mr-lg-5">
	              		<img src="images/zikon.jpg" class="img-responsive" alt="Cinque Terre">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
									<h3 class="mb-2">Anto Indriyanto</h3>
									<h5 class="mb-2">Letnan Kolonel Czi NRP 111111</h5>
									<span class="position mb-4">Komandan</span>
									<div class="faded">
